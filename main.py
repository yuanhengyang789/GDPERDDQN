...
class DualReplayMemoryObstacle:
    def __init__(self, near_capacity, all_capacity, p0=0.3, p1=0.6, beta_t=0.4, total_episodes=NUM_EPISODES):
        ...
        self.beta_t = 0.4  # 前200轮 near_ratio 不为0
        self.min_ratio = 0
        self.max_ratio = 0.6
        self.p0 = p0
        self.p1 = p1
...
def run_algorithm_v2():
    ...
    final_path = test_net(policy_net, start_pos, target_pos, step_v2)  
...
def main():
    ...
    # 将低于-10000的值设为-2000
    rewards1 = np.clip(rewards1, -2000, None)
    rewards2 = np.clip(rewards2, -2000, None)
    rewards3 = np.clip(rewards3, -2000, None)
